...
public interface IRepository<TEntity, in TEntityKey> where TEntity : class
{
    ...
    public Task<IEnumerable<TEntity>> GetAllAsync(IEnumerable<Expression<Func<TEntity, bool>>>? predicates = null,
    ...
    public Task<IEnumerable<TEntity>> GetAllAsync(int skip, int limit,
        IEnumerable<Expression<Func<TEntity, bool>>>? predicates = null, IEnumerable<string>? entitiesToInclude = null);
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation and contains a value that indicates whether such an entity
    ///     exists.
    /// </returns>
